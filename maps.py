...
FIGHT_MAP_1 = {
    ...
    "enemy_infos": [
        ...
        {"x": 214.42, "y": 642.32, "enemy_type": "enemy4"},
        {"x": 214.42, "y": 429.20, "enemy_type": "enemy3"},
    ],
    "crop_rect": {
        "x_ratio": 1.0,
        "y_ratio": 1.0
...
FIGHT_MAP_2 = {
    ...
    "enemy_infos": [
        {"x": 498.15, "y": 262.66, "enemy_type": "enemy1"},
        {"x": 996.30, "y": 262.66, "enemy_type": "enemy4"},
        {"x": 253.51, "y": 682.90, "enemy_type": "enemy1"},
        {"x": 717.00, "y": 682.90, "enemy_type": "enemy2"},
        {"x": 1167.55, "y": 682.90, "enemy_type": "enemy3"},
        {"x": 537.15, "y": 962.23, "enemy_type": "enemy2"},
        {"x": 996.30, "y": 962.23, "enemy_type": "enemy1"}
    ],
    "crop_rect": {
        "x_ratio": 0.9,
        "y_ratio": 0.9
...
FIGHT_MAP_3 = {
    ...
    "enemy_infos": [
        {"x": 289.50, "y": 210.46, "enemy_type": "enemy4"},
        {"x": 593.48, "y": 150.33, "enemy_type": "enemy2"},
        {"x": 796.13, "y": 375.81, "enemy_type": "enemy3"},
        {"x": 1085.63, "y": 450.98, "enemy_type": "enemy2"},
        {"x": 1150.00, "y": 225.50, "enemy_type": "enemy1"},
        {"x": 400.00, "y": 500.00, "enemy_type": "enemy2"},
        {"x": 700.00, "y": 100.00, "enemy_type": "enemy1"},
        {"x": 1300.00, "y": 500.00, "enemy_type": "enemy2"}
    ],
    "crop_rect": {
        "x_ratio": 1.0,
        "y_ratio": 0.5
...
FIGHT_MAP_4 = {
    ...
    "enemy_infos": [
        {"x": 350.00, "y": 180.00, "enemy_type": "enemy1"},
        {"x": 600.00, "y": 250.00, "enemy_type": "enemy3"},
        {"x": 750.00, "y": 500.00, "enemy_type": "enemy1"},
        {"x": 800.00, "y": 700.00, "enemy_type": "enemy4"},
        {"x": 341.00, "y": 350.00, "enemy_type": "enemy1"},
        {"x": 144.00, "y": 295.00, "enemy_type": "enemy2"},
    ],
    "crop_rect": {
        "x_ratio": 0.7,
        "y_ratio": 0.7
...
FIGHT_MAP_5 = {
    ...
    "enemy_infos": [
        {"x": 300.00, "y": 150.00, "enemy_type": "enemy1"},
        {"x": 500.00, "y": 300.00, "enemy_type": "enemy4"},
        {"x": 423.63, "y": 455.31, "enemy_type": "enemy3"},
        {"x": 200.00, "y": 500.00, "enemy_type": "enemy2"},
        {"x": 400.00, "y": 300.00, "enemy_type": "enemy2"}
    ],
    "crop_rect": {
        "x_ratio": 0.5,
        "y_ratio": 0.5
...
FIGHT_MAP_6 = {
    ...
    "enemy_infos": [
        {"x": 300.00, "y": 250.00, "enemy_type": "enemy1"},
        {"x": 550.00, "y": 200.00, "enemy_type": "enemy3"},
        {"x": 750.00, "y": 500.00, "enemy_type": "enemy4"},
        {"x": 600.00, "y": 600.00, "enemy_type": "enemy2"},
        {"x": 500.00, "y": 400.00, "enemy_type": "enemy1"},
        {"x": 150.00, "y": 600.00, "enemy_type": "enemy2"},
        {"x": 950.00, "y": 150.00, "enemy_type": "enemy1"}
    ],
    "crop_rect": {
        "x_ratio": 0.7,
        "y_ratio": 0.7
...
FIGHT_MAP_7 = {
    ...
    "enemy_infos": [
        {"x": 300.00, "y": 450.00, "enemy_type": "enemy1"},
        {"x": 500.00, "y": 450.00, "enemy_type": "enemy2"},
        {"x": 750.00, "y": 650.00, "enemy_type": "enemy1"},
        {"x": 1100.00, "y": 150.00, "enemy_type": "enemy2"},
        {"x": 950.00, "y": 650.00, "enemy_type": "enemy1"},
        {"x": 500.00, "y": 750.00, "enemy_type": "enemy3"},
        {"x": 650.00, "y": 200.00, "enemy_type": "enemy4"},
        {"x": 850.00, "y": 400.00, "enemy_type": "enemy2"}
    ],
    "crop_rect": {
        "x_ratio": 0.8,
        "y_ratio": 0.8
...
FIGHT_MAP_8 = {
    ...
    "enemy_infos": [
        {"x": 130.00, "y": 200.00, "enemy_type": "enemy1"},
        {"x": 830.00, "y": 200.00, "enemy_type": "enemy2"},
        {"x": 350.00, "y": 600.00, "enemy_type": "enemy4"},
        {"x": 750.00, "y": 500.00, "enemy_type": "enemy2"},
        {"x": 800.00, "y": 950.00, "enemy_type": "enemy2"},
        {"x": 250.00, "y": 1300.00, "enemy_type": "enemy1"},
        {"x": 850.00, "y": 1250.00, "enemy_type": "enemy3"},
        {"x": 800.00, "y": 1700.00, "enemy_type": "enemy2"}
    ],
    "crop_rect": {
        "x_ratio": 0.6,
        "y_ratio": 1.5
