weapon_stats = {
    ...
    "gun36": {
        ...
        "cost": "좌: 25 / 우: 0",
        "rank": "4",
        "desc": "지뢰를 발사해서 장애물, 혹은 적에게 직접 붙일 수 있습니다. 원격 기폭을 통해 한거번에 큰 피해를 줄 수 있습니다. (최대 6개 스택)",
        "usage": "좌클릭\n지뢰 발사\n\n우클릭\n원격 기폭"
    },
    "gun37": {
        "name": "프랙처 볼트",
    ...
    "gun38": {
        ...
        "cost": "좌: 60",
        "rank": "5",
        "desc": "아전트 플라즈마를 발사할 수 있는 BFG6000은 UAC에서 설계한 가장 강력한 무기로 여겨집니다. 중요한게 있다면, 이것은 구형 버젼이기에 위력이 많이 약하다는 점입니다. 발사 시, 구체가 생성되며 근처 적에게 덩굴손을 뻗어 피해를 입힙니다.",
...
STAGE_DESCRIPTIONS = {
    "1-1": "폭스트롯 기지를 탈출했습니다.",
    "1-2": "폭스트롯 기지가 파괴되었습니다. 조난 신호를 보내고 있습니다.",
    "1-3": "근처의 리마 기지를 찾았습니다. 곧 도심으로 도착합니다.",
    "2-1": "도심에 도착했습니다. 리마 기지로 가야 합니다.",
    "2-2": "지옥으로 갈 수 있는 방법을 찾았습니다.",
    "2-3": "드디어, 지옥으로 가서 원인을 제거할 수 있습니다.",
...
BOSS_TIPS = {
    ...
    "1-3": "(미정)",
    "2-1": "보스 이름: 돌격대 블리츠\n\"내 방패와 전기 수류탄이 너를 전기구이 통닭으로 만들 것이다.\"",
    "2-2": "보스 이름: 피의 대장장이\n\"동포를 죽인 너를 망치로 제련해서 죽여주마!\"",
    "2-3": "(미정)",
    "3-1": "(미정)",
    "3-2": "보스 이름: 사슬의 감시자\n\"사슬이 닿는 순간, 네 발은 바닥에 묶인다.\"",
    "3-3": "(미정)",
}
...
soldier2_before_dialogue = [
    ...
    {
        "speaker": "NF 군인1",
        "text": "너라도 저것을 처치해 줬으면 좋겠어. 내가 대신 저 괴물의 특징을 알려 줄게…",
        "choices": None,
        "effect": None,
        "next": 3
    },
...
scientist3_before_dialogue = [
    ...
    {
        "speaker": "NF 리마 기지 과학자1",
        "text": "포탈을 열려고 하고 있습니다만… 앞의 괴물이 그것을 막고 있어요.",
        "choices": None,
        "effect": None,
        "next": 2
    },
    {
        "speaker": "NF 리마 기지 과학자1",
        "text": "저희와 새친 연구원님이 함께 분석해본 결과, 저 괴물을 처치하면 즉시 포탈 에너지가 안정화되어서 바로 지옥으로 가는 길이 열릴거에요.",
        "choices": None,
        "effect": None,
        "next": 3
    },
    ...
    {
        "speaker": "NF 리마 기지 과학자1",
        "text": "꼭 저 괴물을 찾고 포탈 에너지를 안정화해주셨으면 해요.",
        "choices": None,
        "effect": None,
        "next": 6
    },
