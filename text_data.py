weapon_stats = {
    ...
    "gun27": {
        ...
        "cost": "좌: 35 / 우: 18",
        "rank": "5",
        "desc": "새친 과학자가 플라즈마 에너지를 재가공해서 만든 그의 역작입니다. 좌클릭은 0.8초 차지 후 굵은 장거리 빔을 발사하고, 우클릭은 즉발 얇은 빔을 발사합니다. 과열 게이지가 꽉 차면 잠시 사용이 봉인됩니다.",
        "usage": "좌클릭\n차지 후 관통 레일빔(과열)\n\n우클릭\n즉발 레일빔"
    },
    "gun28": {
        "name": "심연 특이점 발사기",
        ...
        "cost": "좌: 40 / 우: 0",
        "rank": "5",
        "desc": "새친 과학자가 포탈 에너지의 특이점을 추출해서 만든 무기입니다. 구형 에너지 오브를 쏜 뒤, 원격 기폭으로 특이점을 전개합니다. 영역 안의 적을 안쪽으로 끌어당기며 연속 피해를 줍니다.",
        "usage": "좌클릭\n오브 발사\n\n우클릭\n원격 기폭으로 특이점 전개"
    },
    "gun29": {
        "name": "천둥 연쇄 번개",
        ...
        "cost": "좌: 20 / 우: 28",
        "rank": "5",
        "desc": "새친 과학자가 번개의 특성을 이용해서 만든 무기입니다. 전방으로 번개탄을 쏘아 명중 지점에서 주변 적에게 연쇄합니다. 우클릭은 더 멀리, 더 많이 연쇄됩니다.",
        "usage": "좌클릭\n연쇄 번개 발사(최대 5회 연쇄)\n\n우클릭\n강화 연쇄(최대 7회)"
    },
    "gun30": {
        "name": "프리즘 발사기",
...
doctorNF_dialogue = [
    ...
    {"speaker": "새친 연구원", "text": "좌/우클릭으로 무기를 발사해. 하지만 탄약 게이지를 소모할 거야. 탄약이 바닥나면 V키로 근접 공격해서 충전 오브를 노려봐.", "choices": None, "effect": None, "next": 15},
...
soldier2_before_dialogue = [
    ...
    {
        "speaker": "NF 군인1",
        "text": "현재 저것들은 보통 적들보다 더 높은 체력, 그리고 피해를 가지고 있어. 지금까지 만난 적들보다 더 상위의 적들이야…",
        "choices": None,
        "effect": None,
        "next": 4
    },
    {
        "speaker": "NF 군인1",
        "text": "우리들이 몇몇을 처치했지만, 여전히 많은 괴물들이 있어.",
        "choices": None,
        "effect": None,
        "next": 5
    },
    {
        "speaker": "NF 군인1",
        "text": "주의해. 저것들은 지금 본 것 보다 더 위협적일거다…",
        "choices": None,
        "effect": None,
        "next": 6
    },
