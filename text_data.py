weapon_stats = {
    ...
    "gun21": {
        ...
        "cost": 12,
        "rank": "3",
        "desc": "DMR 스타일의 반자동 라이플. 연사력은 낮지만 단발 화력이 강합니다.",
        "usage": "좌클릭\n느리지만 강력한 단발 사격"
    },
    "gun22": {
        "name": "CSRX 300",
    ...
    "gun23": {
        ...
        "cost": 6,
        "rank": "3",
        "desc": "반자동 전투소총. 손맛 좋은 연사감과 안정적인 정확도를 제공합니다.",
        "usage": "좌클릭\n반자동 연속 사격."
    },
    "gun24": {
        "name": "스팅어",
    ...
    "gun25": {
        ...
        "cost": "9 x 2",
        "rank": "2",
        "desc": "방아쇠 한 번에 샷건을 두 번 빠르게 발사합니다. 잔탄이 1회분이면 한 번만 발사됩니다.",
        "usage": "좌클릭\n두 번 빠르게 연속 발사."
    },
    "gun26": {
        "name": "M249",
    ...
    "gun27": {
        ...
        "cost": "좌: 35 / 우: 18",
        "rank": "5",
        "desc": "고에너지 레일 빔 무기입니다. 좌클릭은 0.8초 차지 후 굵은 장거리 빔을 발사하고, 우클릭은 즉발 얇은 빔을 발사합니다. 과열 게이지가 꽉 차면 잠시 사용이 봉인됩니다.",
        "usage": "좌클릭\n차지 후 관통 레일빔(과열)\n\n우클릭\n즉발 레일빔"
    },
    "gun28": {
        "name": "심연 특이점 발사기",
    ...
    "gun29": {
        "name": "천둥 연쇄 번개",
        "power": "좌: 120 + 연쇄 70 x5 / 우: 120 + 연쇄 70 x7",
        "spread": 0,
        "cost": "좌: 20 / 우: 28",
        "rank": "5",
    ...
    "gun30": {
        "name": "프리즘 발사기",
        "power": "틱당 32(0.08초) / 분광 시 측면빔 45% x2",
        "spread": 0,
        "cost": "초당 25(분광 시 1.35배)",
        "rank": "5",
        "desc": "좌클릭으로 지속 레이저를 방출합니다. 우클릭으로 잠시 ‘분광’ 상태가 되어 좌우에 보조빔이 추가되며 자원 소모와 열이 증가합니다. 과열 시 일정 시간 사용이 봉인됩니다.",
        "usage": "좌클릭(홀드)\n지속 레이저\n\n우클릭(홀드)\n분광 펄스(보조빔 활성)"
    },
    "gun31": {
        "name": "마이크로미사일 벌집기",
        ...
        "cost": "미사일당 17",
        "rank": "5",
        "desc": "조준 콘 내의 적을 락온한 뒤, 버튼을 떼면 락온 수만큼 유도 미사일을 일제히 발사합니다. 탄약이 부족하면 가능한 수만큼만 발사합니다.",
        "usage": "좌클릭(홀드)\n적 락온(최대 6)\n좌클릭 해제\n일제 발사"
    },
    "gun32": {
        "name": "오메가 쇼트건",
        ...
        "cost": "좌: 25 / 우: 30",
        "rank": "4",
        "desc": "초근접 섬멸용 산탄총입니다. 좌클릭은 광역 산탄, 우클릭은 관통 슬러그 3연발 버스트를 발사합니다.",
        "usage": "좌클릭\n광역 산탄 사격\n\n우클릭\n슬러그 3점사(관통)"
    },
}
