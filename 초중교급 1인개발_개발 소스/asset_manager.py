...
def load_images():
    ...
    gun33_img = pygame.transform.smoothscale(gun33_img, (30, int(gun33_img.get_height() * (30 / gun33_img.get_width()))))
    ...
    gun38_img = pygame.image.load(path_image("Image", "Gun", "Gun38Player.png")).convert_alpha()
    gun38_img = pygame.transform.smoothscale(gun38_img, (60, int(gun38_img.get_height() * (60 / gun38_img.get_width()))))

    gun39_img = pygame.image.load(path_image("Image", "Gun", "Gun39Player.png")).convert_alpha()
    gun39_img = pygame.transform.smoothscale(gun39_img, (55, int(gun39_img.get_height() * (55 / gun39_img.get_width()))))

    gun40_img = pygame.image.load(path_image("Image", "Gun", "Gun40Player.png")).convert_alpha()
    gun40_img = pygame.transform.smoothscale(gun40_img, (35, int(gun40_img.get_height() * (35 / gun40_img.get_width()))))

    gun41_img = pygame.image.load(path_image("Image", "Gun", "Gun41Player.png")).convert_alpha()
    gun41_img = pygame.transform.smoothscale(gun41_img, (55, int(gun41_img.get_height() * (55 / gun41_img.get_width()))))

    gun42_img = pygame.image.load(path_image("Image", "Gun", "Gun42Player.png")).convert_alpha()
    gun42_img = pygame.transform.smoothscale(gun42_img, (55, int(gun42_img.get_height() * (55 / gun42_img.get_width()))))

    gun43_img = pygame.image.load(path_image("Image", "Gun", "Gun43Player.png")).convert_alpha()
    gun43_img = pygame.transform.smoothscale(gun43_img, (55, int(gun43_img.get_height() * (55 / gun43_img.get_width()))))

    gun44_img = pygame.image.load(path_image("Image", "Gun", "Gun44Player.png")).convert_alpha()
    gun44_img = pygame.transform.smoothscale(gun44_img, (55, int(gun44_img.get_height() * (55 / gun44_img.get_width()))))

    gun45_img = pygame.image.load(path_image("Image", "Gun", "Gun45Player.png")).convert_alpha()
    gun45_img = pygame.transform.smoothscale(gun45_img, (45, int(gun45_img.get_height() * (45 / gun45_img.get_width()))))

    gun46_img = pygame.image.load(path_image("Image", "Gun", "Gun46Player.png")).convert_alpha()
    gun46_img = pygame.transform.smoothscale(gun46_img, (55, int(gun46_img.get_height() * (55 / gun46_img.get_width()))))

    gun47_img = pygame.image.load(path_image("Image", "Gun", "Gun47Player.png")).convert_alpha()
    gun47_img = pygame.transform.smoothscale(gun47_img, (55, int(gun47_img.get_height() * (55 / gun47_img.get_width()))))

    gun48_img = pygame.image.load(path_image("Image", "Gun", "Gun48Player.png")).convert_alpha()
    gun48_img = pygame.transform.smoothscale(gun48_img, (55, int(gun48_img.get_height() * (55 / gun48_img.get_width()))))

    gun49_img = pygame.image.load(path_image("Image", "Gun", "Gun49Player.png")).convert_alpha()
    gun49_img = pygame.transform.smoothscale(gun49_img, (55, int(gun49_img.get_height() * (55 / gun49_img.get_width()))))

    gun50_img = pygame.image.load(path_image("Image", "Gun", "Gun50Player.png")).convert_alpha()
    gun50_img = pygame.transform.smoothscale(gun50_img, (55, int(gun50_img.get_height() * (55 / gun50_img.get_width()))))
    ...
    mine_img = pygame.transform.smoothscale(mine_img, (40, 40))
    ...
    boss5_img = pygame.image.load(path_image("Image", "character", "Boss5.png")).convert_alpha()
    boss5_img = pygame.transform.smoothscale(boss5_img, (120, 120))

    boss6_img = pygame.image.load(path_image("Image", "character", "Boss6.png")).convert_alpha()
    boss6_img = pygame.transform.smoothscale(boss6_img, (120, 120))

    boss7_img = pygame.image.load(path_image("Image", "character", "Boss7.png")).convert_alpha()
    boss7_img = pygame.transform.smoothscale(boss7_img, (200, 200))
...
def load_weapon_assets(images, on_progress=None, progress_cb=None):
    ...
    weapons = {
        ...
        "gun33": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun33.png")).convert_alpha(),
            "topdown": images["gun33"],
            "bullets": [],
            "cartridges": [],
        },
        "gun34": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun34.png")).convert_alpha(),
            "topdown": images["gun34"],
            "bullets": [images["bullet1"]],
            "cartridges": [images["cartridge_case2"]],
        },
        "gun35": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun35.png")).convert_alpha(),
            "topdown": images.get("gun35"),
            "bullets": [images["grenade1"]],
            "cartridges": [],
        },
        "gun36": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun36.png")).convert_alpha(),
            "topdown": images.get("gun36"),
            "bullets": [images["mine"]],
            "cartridges": [],
        },
        "gun37": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun37.png")).convert_alpha(),
            "topdown": images.get("gun37"),
            "bullets": [],
            "cartridges": [],
        },
        "gun38": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun38.png")).convert_alpha(),
            "topdown": images.get("gun38"),
            "bullets": [],
            "cartridges": [],
        },
        "gun39": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun39.png")).convert_alpha(),
            "topdown": images["gun39"],
            "bullets": [images["bullet1"]],
            "cartridges": [images["cartridge_case1"]],
        },
        "gun40": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun40.png")).convert_alpha(),
            "topdown": images["gun40"],
            "bullets": [images["bullet1"]],
            "cartridges": [],
        },
        "gun41": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun41.png")).convert_alpha(),
            "topdown": images["gun41"],
            "bullets": [
                [images["bullet1"]],
                [images["bullet2"]],
            ],
        ...
        "gun42": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun42.png")).convert_alpha(),
            "topdown": images["gun42"],
            "bullets": [images["bullet1"]],
            "cartridges": [images["cartridge_case1"]],
        },
        "gun43": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun43.png")).convert_alpha(),
            "topdown": images["gun43"],
            "bullets": [images["bullet1"]],
            "cartridges": [images["cartridge_case1"]],
        },
        "gun44": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun44.png")).convert_alpha(),
            "topdown": images["gun44"],
            "bullets": [images["bullet1"]],
            "cartridges": [images["cartridge_case1"]],
        },
        "gun45": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun45.png")).convert_alpha(),
            "topdown": images["gun45"],
            "bullets": [images["bullet1"]],
            "cartridges": [images["cartridge_case1"]],
        },
        "gun46": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun46.png")).convert_alpha(),
            "topdown": images["gun46"],
            "bullets": [images.get("grenade1")],
            "cartridges": [],
            "explosion": images["explosion1"],
       },
        "gun47": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun47.png")).convert_alpha(),
            "topdown": images["gun47"],
            "bullets": [images.get("mine")],
            "cartridges": [],
        },
        "gun48": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun48.png")).convert_alpha(),
            "topdown": images["gun48"],
            "bullets": [images["gun48"]],
            "cartridges": [],
        },
        "gun49": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun49.png")).convert_alpha(),
            "topdown": images["gun49"],
            "bullets": [],
            "cartridges": [],
        },
        "gun50": {
            "front": pygame.image.load(os.path.join(ASSET_DIR, "Image", "Gun", "Gun50.png")).convert_alpha(),
            "topdown": images["gun50"],
            "bullets": [],
            "cartridges": [],
        },
    }
