...
def load_sounds():
    ...
    weapon_sounds = {
        ...
        "gun44_hook": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun44Hook.mp3")),
        "gun44_explosion": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun44Explosion.mp3")),
        "gun45_fire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun45Fire.mp3")),
        "gun45_explosion": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun45Explosion.mp3")),
        "gun46_fire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun46Fire.mp3")),
        "gun46_explosion": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun46Explosion.mp3")),
        "gun47_fire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun47Fire.mp3")),
        "gun47_explosion": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun47Explosion.mp3")),
        "gun48_fire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun48Fire.mp3")),
        "gun49_fire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun49Fire.mp3")),
        "gun49_complete": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun49Complete.mp3")),
        "gun49_explosion": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun49Explosion.mp3")),
        "gun50_leftfire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun50LeftFire.mp3")),
        "gun50_rightfire": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun50RightFire.mp3")),
        "gun50_hit": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun50Hit.mp3")),
        "gun50_explosion": pygame.mixer.Sound(path_sound("Sound", "Gun", "Gun50Explosion.mp3")),
    }
